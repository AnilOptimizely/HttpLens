...
public class ApiKeyAuthTests
{
    ...
    /// <summary>Test: Dashboard with no key → 401.</summary>
    [Fact]
    ...
    /// <summary>Test: Dashboard with correct key in query → 200.</summary>
    [Fact]
    ...
    /// <summary>Test: Dashboard with wrong key → 401.</summary>
    [Fact]
    ...
    /// <summary>Test: API with correct X-HttpLens-Key header → 200.</summary>
    [Fact]
    ...
    /// <summary>Test: API with wrong header value → 401.</summary>
    [Fact]
    ...
    /// <summary>Test: API with no header → 401.</summary>
    [Fact]
    ...
    /// <summary>Test: Export curl with correct header → 200.</summary>
    [Fact]
    ...
    /// <summary>Test: DELETE with correct header → 204.</summary>
    [Fact]
    ...
    /// <summary>Test: DELETE without key → 401.</summary>
    [Fact]
    ...
    /// <summary>Test: API with correct ?key= → 200.</summary>
    [Fact]
    ...
    /// <summary>Test: API with wrong ?key= → 401.</summary>
    [Fact]
    ...
    /// <summary>Test: App route not affected by API key.</summary>
    [Fact]
    ...
    /// <summary>Test: Another app route not affected.</summary>
    [Fact]
    ...
    /// <summary>Test: Dashboard loads without auth when no API key configured.</summary>
    [Fact]
    ...
    /// <summary>Test: API works without auth when no API key configured.</summary>
    [Fact]
